...
app.get('/zipcode_auto' , function (req, res)
{
   ...
   var auto_zip_url = 'http://api.geonames.org/postalCodeSearchJSON?postalcode_startsWith='+parameters.zip+'&username=srikarrampally96&country=US&maxRows=5';
...
app.get('/searching' , function (req, res)
{
   ...
   var search_url = 'http://svcs.ebay.com/services/search/FindingService/v1?OPERATION-NAME=findItemsAdvanced&SERVICE-VERSION=1.0.0&SECURITY-APPNAME=SrikarRa-srikarhw-PRD-816e08212-88cb6341&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD&paginationInput.entriesPerPage=50&keywords='+encodeURI(parameters.Keyword)+'&buyerPostalCode='+parameters.buyerPostalCode;
...
app.get('/shopping' , function (req, res)
{
   ...
   res.setHeader("Access-Control-Allow-Origin","*");
   var parameters = url.parse(req.url, true).query;
   var shopping_url = 'http://open.api.ebay.com/shopping?callname=GetSingleItem&responseencoding=JSON&appid=SrikarRa-srikarhw-PRD-816e08212-88cb6341&siteid=0&version=967&ItemID='+parameters.itemId+'&IncludeSelector=Description,Details,ItemSpecifics';
...
app.get('/google_search' , function (req, res)
{
   ...
   res.setHeader("Access-Control-Allow-Origin","*");
   var parameters = url.parse(req.url, true).query;
   var google_url = 'https://www.googleapis.com/customsearch/v1?q='+encodeURI(parameters.googlesearching)+'&cx=010618545303057637593:vvou7p-g_us&imgSize=huge&imgType=news&num=8&searchType=image&key=AIzaSyDicNVRiuP9Sr2LZj6Z4rKM1_4afF6qtTs';
...
app.get('/similarsearching' , function (req, res)
{
   ...
   res.setHeader("Access-Control-Allow-Origin","*");
   var parameters = url.parse(req.url, true).query;
   var similar_url = 'http://svcs.ebay.com/MerchandisingService?OPERATION-NAME=getSimilarItems&SERVICE-NAME=MerchandisingService&SERVICE-VERSION=1.1.0&CONSUMER-ID=SrikarRa-srikarhw-PRD-816e08212-88cb6341&RESPONSE-DATA-FORMAT=JSON&REST-PAYLOAD&itemId='+parameters.itemids;
